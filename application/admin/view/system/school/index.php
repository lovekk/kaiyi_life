    ...
    <div class="col-sm-12">
        <div class="ibox">
            <div class="ibox-title">
                <button type="button" class="btn btn-w-m btn-primary" onclick="$eb.createModalFrame(this.innerText,'{:Url('create')}')">添加学校/小区</button>
                    ...
                    <div class="m-b m-l">
                        <form action="" class="form-inline">
                            ...
                            <div class="input-group">
                                <input type="text" name="keyword" value="{$params.keyword}" placeholder="学校/小区名称或者类型" class="input-sm form-control"> <span class="input-group-btn">
